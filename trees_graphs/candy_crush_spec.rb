require_relative "./candy_crush"

describe "#candy_crush" do
  it "returns a stable board for provided example 1" do
  ...
  it "returns a stable board for provided example 2" do
